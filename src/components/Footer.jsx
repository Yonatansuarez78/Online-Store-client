                ...
                {showSVG ? (
                    <svg
                        ...
                        <path
                            fill="#161627"
                            fillOpacity="1"
                            d="M0,160L60,154.7C120,149,240,139,360,144C480,149,600,171,720,160C840,149,960,107,1080,101.3C1200,96,1320,128,1380,144L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z" ></path>
                    </svg>
                ) : (
                    <svg
                        className="fond"
            ...
            <footer className="w-100">
                <div className="footer__container">
                    <div className="row d-flex">
                        <div className="col-12 col-md-6 text-center text-md-start newsletter">
                            <div className='mx-auto'>
                                <img src={OnlineStore} style={{ width: "50%" }}></img>
                                <ul className="footer__list my-4 text-center">
                                    <li className="footer__list-item me-2">
                                        <a target="_blank" href="https://web.facebook.com" className="footer__list-link" >
                                            <img src={facebook}  width="24px" className="ms-2"  alt=""
                                            ></img>
                                        </a>
                                    </li>
                                    <li className="footer__list-item me-2">
                                        <a target="_blank"  href="https://www.instagram.com"  className="footer__list-link" >
                            ...
                            <div className=''>
                                ...
                                <ul className="footer__list">
                                    ...
                                    <li className="footer__list-item">
                                        ...
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=573182268916" className="footer__list-link ms-1" > +57 3182268916   </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
